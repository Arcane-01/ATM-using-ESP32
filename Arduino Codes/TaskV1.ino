...
String GOOGLE_SCRIPT_ID = "AKfycbxwvNAImt8daIRrf7hc1jmtd5AJU1VhuCIHQooyvEDC3GzWkLXW8RHvb25GeUhsrxiQ";    // change Gscript ID
...
void handleNewMessages(int numNewMessages) {
  ...
  // Start Function: Prompts the user to various available functions
    ...
    if (prev_text == "/Enter_PIN"){
      ...
      if(v==0){
        Logged_in = true;
        String keyboardJson = "[[\"/Debit\", \"/Credit\"],[\"/PIN_Change\",\"/Exit\"]";
